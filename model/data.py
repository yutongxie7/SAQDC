...
def load_and_encode_train_data(num_queries, num_materialized_samples):
    ...
    return dicts, column_min_max_vals, min_val, max_val, labels_train, labels_test, max_num_predicates, train_data, test_data
...
def make_dataset( predicates, labels, max_num_predicates):
    ...
    return dataset.TensorDataset( predicate_tensors,  target_tensor,  predicate_masks)
